...
class UserController extends Controller
{
    ...
    public function update(Request $request, string $uuid)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'academic_degree' => 'nullable|max:255',
            'specialization' => 'nullable|max:255',
            'biography' => 'nullable|max:1000',
            'publications' => 'nullable|max:1000',
            'available_for_review' => 'nullable|boolean',
            'max_reviews_per_month' => 'nullable|integer|min:1|max:20',
            'preferred_review_types' => 'nullable|array',
