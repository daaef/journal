<x-auth_layout>
    ...
    <header class="lg:grid grid-cols-2 h-screen">
        <div
            class="flex justify-center px-4 h-full overflow-y-auto sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        ...
        <div class="relative hidden w-full flex-1 lg:block">
            <img class="absolute inset-0 h-full w-full object-cover" src="{{ asset('images/registerImg.png') }}" alt="">
        </div>
    </header>
