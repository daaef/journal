<header class="flex flex-wrap sm:justify-start h-[80px] sm:flex-nowrap w-full fixed z-[20000] bg-white text-sm py-3">
    <nav class="container w-full mx-auto px-4 flex flex-wrap basis-full items-center justify-between relative">
        <div class="flex gap-5 items-center">
            <a class="flex-none text-xl sm:static sm:translate-y-0 absolute top-[30px] left-[20px] translate-y-[-50%] font-semibold dark:text-white focus:outline-none focus:opacity-80" href="#">
                <img class="h-14" src="{{ asset('images/japr-logo.png') }}" alt="japr logo">
            </a>
            <div id="hs-navbar-alignment" class="hs-collapse hidden overflow-hidden top-[80px] transition-all duration-300 basis-full grow sm:grow-0 sm:basis-auto sm:static sm:px-0 px-[20px] py-[20px] fixed left-0 bg-white w-full sm:block" aria-labelledby="hs-navbar-alignment-collapse">
