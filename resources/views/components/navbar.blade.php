<header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full fixed z-[20000] bg-white text-sm py-3">
    <nav class="container w-full mx-auto px-4 flex flex-wrap basis-full items-center justify-between">
        ...
        <div class="flex items-center gap-x-2">
            ...
            <a href="{{ route('auth.login.get') }}" class="py-2 px-6 inline-flex items-center gap-x-2 text-sm font-medium rounded-[15px] border border-primary-500 text-primary-500 hover:border-primary-600 hover:text-primary-600 focus:outline-none focus:border-primary-600 focus:text-primary-600 disabled:opacity-50 disabled:pointer-events-none">
                Login
            </a>
            <a href="{{ route('auth.register.get') }}" class="py-2 px-6 inline-flex items-center gap-x-2 text-sm font-medium rounded-[15px] border border-transparent bg-primary-500 text-white hover:bg-primary-600 focus:outline-none focus:bg-primary-700 disabled:opacity-50 disabled:pointer-events-none">
                Register
            </a>
        </div>
    </nav>
