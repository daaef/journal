...
{{-- 
                    ...
                    <li class="sidebar-menu__item">
                        <a href="{{ route('reviewer.notifications.dashboard') }}" class="sidebar-menu__link">
                            <span class="icon"><i class="ph ph-bell"></i></span>
                            <span class="text">Notifications</span>
                        </a>
                    </li>
                    <li class="sidebar-menu__item">
                        <a href="{{ route('reviewer.user.settings', auth()->user()->uuid) }}" class="sidebar-menu__link">
                        ...
                        <div class="card border border-gray-100 rounded-12 box-shadow-custom">
                            <div class="card-body">
                                ...
                                <ul class="max-h-270 overflow-y-auto scroll-sm pe-4">
                                    <li class="mb-4">
                                        <a href="{{ route('reviewer.user.settings', auth()->user()->uuid) }}"
