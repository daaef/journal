                ...
                <li class="sidebar-menu__item has-dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li class="sidebar-submenu__item">
                            <a href="{{ route('editor.journals.approved') }}" class="sidebar-submenu__link"> Approved </a>
                        </li>
                        <li class="sidebar-submenu__item">
                            <a href="{{ route('editor.journals.pendingApproval') }}" class="sidebar-submenu__link"> Pending </a>
                        </li>
                    </ul>
                    <!-- Submenu End -->
                </li>
