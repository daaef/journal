...
<div class="journal">
    <div class="flex flex-col bg-white border border-gray-200 shadow-sm rounded-[8px] p-4 md:p-5">
        <h3 class="font-semibold text-lg mb-2">Climate Change and African Agriculture</h3>
        ...
        <div class="grid grid-cols-[1fr_2px_1fr]">
            <div class="py-3 space-y-3]">
                <h5 class="flex w-full justify-between">
                    ...
                    <span class="w-[50%]">Ahmed Musa Akindele</span>
                </h5>
                <h5 class="flex w-full justify-between">
                ...
                <h5 class="flex w-full justify-between">
                    ...
                    <span class="w-[50%]">Green Planet</span>
                </h5>
                <h5 class="flex w-full justify-between">
                    <span class="text-secondary-900 w-[45%]">Resource Type:</span>
                    <span class="w-[50%]">Journal</span>
                </h5>
                <h5 class="flex w-full justify-between">
            ...
            <div class="py-3 space-y-3] w-full pl-5">
                ...
                <h5 class="flex w-full justify-between">
                    ...
                    <span class="w-[50%]">English and French</span>
                </h5>
                <h5 class="flex w-full justify-between">
        ...
        <div class="flex justify-between mt-4">
            <div class="flex gap-x-3">
                <button class="text-gray-100 bg-primary-500 rounded-[8px] px-4 py-1 font-bold hover:bg-primary-600">View</button>
