            ...
            <div class="card mt-24 overflow-hidden">
                <div class="card-header">
                    <div class="mb-0 flex-between flex-wrap gap-8">
                        <h4 class="mb-0">All Reviewed Manuscripts</h4>
                        <a href=""
                    ...
                    <table class="table style-two mb-0">
                        ...
                        <tbody>
                                    ...
                                    <td>
                                        <!-- <div class="flex-align gap-8 mt-12">
                                            <div class="progress w-100px  bg-main-100 rounded-pill h-4"
                                                ...
                                                <div class="progress-bar bg-warning-600 rounded-pill" style="width: 100%">
                                                </div>
                                            </div>
                                            <span class="text-warning-600 flex-shrink-0 text-13 fw-medium">100%</span>
                                        </div> -->
                                    </td>
                                    <td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3">
                                        <p class="mt-2 text-gray-500 dark:text-neutral-400">No reviewed manuscripts at the
                                            moment</p>
                                    </td>
                                </tr>
                            @endforelse
