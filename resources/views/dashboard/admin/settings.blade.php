<x-layouts.admin_layout>
    ...
    <div class="card">
        ...
        <form method="post" action="{{ route('admin.user.settings.update', $user->uuid) }}" class="card-body settings-form">
            @csrf
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="regional_expertise[]" id="regional_expertise" multiple 
                                class="form-control @error('regional_expertise') is-invalid @enderror">
                            @php
                        ...
                        @error('regional_expertise')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Hold Ctrl/Cmd to select multiple regions. Selected items will be highlighted in blue.</p>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        @error('research_interests')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Hold Ctrl/Cmd to select multiple interests. Selected items will be highlighted in blue.</p>
                    </div>
